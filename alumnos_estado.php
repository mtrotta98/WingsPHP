    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT apellido,nombre,id_personas,fecha_nacimiento FROM alumnos WHERE activo=0 order by apellido,nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="estado(<?php echo $row['id_personas']; ?>)"><i class="fa fa-book" style="font-size: 25px;;cursor:pointer;"></i></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <script>
            ...
            function estado(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=18&accion=cambiarAlumno",
                    data: {
                        id:id
                    },
