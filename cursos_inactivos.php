    ...
    <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Listado de Cursos Inactivos</h1>
                            </div>  
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM cursos WHERE activo=0 order by nombre_curso";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="cambiar(<?php echo $row['id_curso']; ?>)"><i class="fa fa-fw fa-edit" style="font-size: 25px;;cursor:pointer;"></i></a></td>
        ...
        <script>
            ...
            var id = id;
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=18&accion=cambiarCurso",
                    data: {
                        id:id
                    },
