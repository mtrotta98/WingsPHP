    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action= "#" method= "post" name= "formulario_actualiza_tutor" id="formulario_actualiza_tutor" onsubmit="enviar_ajax(); return false">
                        <div class="col-md-12">
                            <div class="card card-info">
                                ...
                                <div class="card-body" style="display: block;">
                                    <?php
                                    $sql = "SELECT * FROM tutores WHERE id_tutor = $id order by apellido,nombre";
                                    if ($res_existe = $mysqli->query($sql)) {
                                        $row = $res_existe->fetch_array(MYSQLI_ASSOC);
                                        if($row){
                                            $sql2 = "SELECT * FROM telefonos WHERE id_tutor = $id";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="number" id="fijo" class="form-control" placeholder="Numero" name="fijo" value=<?php echo $row2['numero_fijo'] ?>>
                                        </div>
                                        <div class="col-6">
                                            <label>Telefono Celular</label>
                                            <input type="number" id="cel" class="form-control" placeholder="Numero" name="cel" value=<?php echo $row2['numero_celular'] ?>>
                                        </div>
                                        <div class="col-6">
                                            <label>Email</label>
                                            <input type="text" id="email" class="form-control" placeholder="Email" name="email" value=<?php echo $row['mail'] ?>>
                                        </div>
                                        <div class="col-12">
                                            <div class="card-body">
                                                <div class="row">
        ...
        <script>
            $("#actualiza").click(function () {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=1&accion=actualiza",
                    data: $("#formulario_actualiza_tutor").serialize(),
                    dataType: "html",
                    success: function (data) {
                        alert("Datos Actualizados!!!");
                        //alert(data);
                        window.location = "tutores.php";
                    }
                });
            });
