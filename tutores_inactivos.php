            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Listado de Tutores Inactivos</h1>
                            </div>  
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT apellido,nombre,id_tutor,dni FROM tutores WHERE activo=0 order by apellido,nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="cambiar(<?php echo $row['id_tutor'];?>)"><i class="fa fa-fw fa-edit" style="font-size: 25px;;cursor:pointer;"></i></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <script>
           function cambiar(id){
            var id = id;
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=18&accion=cambiarTutor",
                    data: {
                        id:id
                    },
