...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 5px;">ALUMNOS A CARGO</th>
                                                <?php //} ?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $sql = "SELECT apellido,nombre,id_tutor,dni FROM tutores WHERE activo=1 order by apellido,nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="edita(<?php echo $row['id_tutor'];?>)"><i class="fa fa-fw fa-edit" style="font-size: 25px;;cursor:pointer;"></i></a></td>
                                                    <td><a onclick="borra(<?php echo $row['id_tutor']; ?>)"><i class="fa fa-fw fa-trash" style="font-size: 25px;;cursor:pointer;"></i></a></td>
                                                    <td><a onclick="alumnos_a_cargo(<?php echo $row['id_tutor']; ?>)"><i class="fa fa-users" style="font-size: 25px;cursor:pointer;"></i></a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
        ...
        <script>
            function edita(id) {
                var id = id;
                window.location = "edita_tutores.php?id=" + id
            }
            ...
            function borra(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=3&accion=consulta",
                    data: {
                        id: id
                    },
                    success: function (data) {
                        ...
                        window.location.reload();
                            ...
                            alert("No se elimino al tutor")
                        }
                    }
                });
            }

            function alumnos_a_cargo(id){
                var id = id;
                window.location = "alumnos_a_cargo.php?id=" + id
            }
