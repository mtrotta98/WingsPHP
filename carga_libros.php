            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Alta de libros</h1>
                            </div>  
                        </div>
                    </div>
                </div>
                <section class="content">
                    <form action= "#" method= "post" name= "formulario_carga_libro" id="formulario_carga_libro" onsubmit="enviar_ajax(); return false">
                        <div class="col-md-12">
                            <div class="card card-info">
                                ...
                                <div class="card-body" style="display: block;">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label>Autor</label>
                                            <input type="text" id="autor" class="form-control" placeholder="Nombres" name="autor">
                                        </div>
                                        <div class="col-6">
                                            <label>Editor/a</label>
                                            <input type="text" id="editor" class="form-control" placeholder="Nombres" name="editor">
                                        </div>
                                        <div class="col-12">
                                            <div class="card-body">
                                                <div class="row">
...
<script>
        function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=8&accion=cargar",
                    data: $("#formulario_carga_libro").serialize(),
