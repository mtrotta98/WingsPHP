...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center;">APELLIDO Y NOMBRE ALUMNO</th> 
                                                <th style="text-align:center;">FECHA CARGA</th>
                                                <th style="text-align:center;">NOMBRE Y TELEFONO EMERGENCIA</th>
                                                <th style="width: 5px;">EDITAR</th>
                                                <th style="width: 5px;">BORRAR</th>
                                                <th style="width: 5px;">IMPRIMIR</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM alumnos a INNER JOIN fichas_salud fs ON (a.id_personas = fs.id_alumno) WHERE fs.activo=1 order by apellido,nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"> <?php echo $row["fecha_carga"] ?></td>
                                                    <td style="text-align: center;"> <?php echo $row["nombre_emergencia"] . " " . $row["telefono_emergencia"] ?></td>
                                                    ...
                                                    <td><a href="imp_fichas.php?id=<?php echo $row['id_personas']; ?>" target="_balnk"><i class="fa fa-fw fa-print" style="font-size: 25px;;cursor:pointer;"></i></a></td>
        ...
        <script>
            function edita(id) {
                var id = id;
                window.location = "edita_fichas.php?id=" + id
            }
            ...
            function borra(id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=13&accion=consulta",
                    data: {
                        id: id
                    },
                    success: function (data) {
                        ...
                        if (mensaje) {
                            $.ajax({
                                type: "POST",
                                url: "acciones.php?valor=13&accion=eliminar",
                                data: {
                                    id: id
                                },
                                success: function (data) {
            ...
            function cursos(id){
                var id = id;
                window.location = "listado_cursos.php?id=" + id
            }
