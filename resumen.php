...
$ingresos = 'SELECT sum(cc.monto) as total from pagos p
                            ...
                            WHERE cc.pago=1 and MONTH(p.fecha)=MONTH(NOW())';
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        ...
                                        <tbody>
                                            ...
                                            AS fecha,  
                                            CONCAT(apellido, ' ',nombre, ' CUOTA ', cuota) as nombre, cc.monto, a.id_personas, cc.id_cc, p.id_pago
                                            FROM
                                            pagos p
                                            LEFT JOIN cuenta_corriente cc ON p.id_cc = cc.id_cc 
                                            ...
                                            WHERE
                                            cc.pago = 1 
                                            AND MONTH ( p.fecha ) = MONTH ( NOW( ) ) ORDER BY cc.cuota";
