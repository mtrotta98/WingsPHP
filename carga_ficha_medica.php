...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Alta de Fichas</h1>
                        </div>
                    </div>
                </div>
            </div>
            <section class="content">
                <form action="#" method="post" name="formulario_carga_ficha" id="formulario_carga_ficha" onsubmit="enviar_ajax(); return false">
                    <div class="col-md-12">
                        <div class="card card-info">
                            ...
                            <?php 
                                $sql = "SELECT dni FROM alumnos WHERE id_personas = $id";
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="docAl" class="form-control" placeholder="Dni" name="docAl" readonly value='<?php echo $row['dni'] ?>'>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="nomEm" class="form-control" placeholder="Nombre" name="nomEm" required>
                                    </div>
                                    <div class="col-6">
                                        <label>Numero de Emergencia</label>
                                        <input type="number" id="numEm" class="form-control" placeholder="Numero" name="numEm" required>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" data-inputmask-alias="date" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" id="datemask" name="fecha">
                                            </div>
                                                <!-- /.input group -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div id="content" style="display: block;">
                                            <input type="text" id="desc_enf" class="form-control" placeholder="Descripcion" name="desc_enf">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div id="content2" style="display: block;">
                                            <input type="text" id="desc_trat" class="form-control" placeholder="Descripcion" name="desc_trat">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div id="content3" style="display: block;">
                                            <input type="text" id="desc_inter" class="form-control" placeholder="Descripcion" name="desc_inter">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div id="content4" style="display: block;">
                                            <input type="text" id="desc_medi" class="form-control" placeholder="Descripcion" name="desc_medi">
                                        </div>
                                    </div>
    ...
    <script>
        function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=11&accion=cargar",
                    data: $("#formulario_carga_ficha").serialize(),
