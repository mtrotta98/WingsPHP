...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form action="#" method="post" name="formulario_carga_tutor" id="formulario_carga_tutor" onsubmit="enviar_ajax(); return false">
                    <div class="col-md-12">
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="number" id="docAl" class="form-control" maxlength="8" placeholder="DNI" name="docAl" required>
                                    </div>
                                    <div class="col-6">
    ...
    <script>
        function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=1&accion=cargar",
                    data: $("#formulario_carga_tutor").serialize(),
