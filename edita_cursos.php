...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Editar Cursos</h1>
                        </div>
                    </div>
                </div>
            </div>
            <section class="content">
                <form action="#" method="post" name="formulario_edita_curso" id="formulario_edita_curso" onsubmit="enviar_ajax(); return false">
                    <div class="col-md-12">
                            ...
                            <div class="card-body" style="display: block;">
                                ...
                                <div class="row">
                                    <div class="col-3"> 
                                        ...
                                        <input type="text" id="id" class="form-control" placeholder="Id" name="id" value='<?php echo $id ?>' readonly>
                                    </div>
                                    <div class="col-9"> 
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="nom" class="form-control" placeholder="Nombres" name="nom" value='<?php echo $row['nombre_curso'] ?>' required>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <textarea id="descripcion" class="form-control" placeholder="Descripcion" name="descripcion" maxlength="255"><?php echo $row['descripcion'] ?></textarea>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control timepicker" id="horaIn" name="horaIn" value='<?php echo $row['horaIn'] ?>'>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control timepicker" id="horaFin" name="horaFin" value='<?php echo $row['horaFin'] ?>'>
    ...
    <script>
        ...
        function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=6&accion=actualiza",
                    data: $("#formulario_edita_curso").serialize(),
