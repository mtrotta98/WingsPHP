    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action= "#" method= "post" name= "formulario_carga_gastos" id="formulario_carga_gastos" onsubmit="enviar_ajax(); return false">
                        <div class="col-md-12">
                                ...
                                <div class="card-body" style="display: block;">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" id="concepto" name="concepto" class="form-control"   placeholder="Concepto" required> 
                                        </div>
                                        <div class="col-4">
        ...
        <script>
            ...
            function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=14&accion=cargar",
                    data: $("#formulario_carga_gastos").serialize(),
