    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT id_libro, nombre, autor, editora FROM libros WHERE activo=0 order by nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="cambiar(<?php echo $row['id_libro']; ?>)"><i class="fa fa-fw fa-edit" style="font-size: 25px;;cursor:pointer;"></i></a></td>
        ...
        <script>
            ...
            var id = id;
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=18&accion=cambiarLibro",
                    data: {
                        id:id
                    },
