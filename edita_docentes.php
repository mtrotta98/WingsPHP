    ...
    <body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Actualizar Docente</h1>
                            </div>  
                        </div>
                    </div>
                </div>
                <section class="content">
                    <form action= "#" method= "post" name= "formulario_actualiza_docente" id="formulario_actualiza_docente" onsubmit="enviar_ajax(); return false">
                        <div class="col-md-12">
                            <div class="card card-info">
                                ...
                                <div class="card-body" style="display: block;">
                                    <?php
                                    $sql = "SELECT * FROM docentes WHERE id_docente = $id order by apellido,nombre";
                                    if ($res_existe = $mysqli->query($sql)) {
                                        $row = $res_existe->fetch_array(MYSQLI_ASSOC);
                                        if($row){
                                            $sql2 = "SELECT * FROM telefonos WHERE id_docente = $id";
                                        ...
                                        <div class="col-12">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <input type="button" class="btn btn-block btn-default" value="Cancelar" onclick="location.href = 'docentes.php'">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                                           
        ...
        <script>
            ...
            function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=4&accion=actualiza",
