    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped" style="font-size: 12px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 5px;">CAMBIAR ESTADO</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM alumnos a INNER JOIN fichas_salud fs ON (a.id_personas = fs.id_alumno) WHERE fs.activo=0 order by apellido,nombre";
                                            ...
                                            while ($row = $res_existe->fetch_array(MYSQLI_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a onclick="cambiar(<?php echo $row['id_ficha'];?>)"><i class="fa fa-fw fa-edit" style="font-size: 25px;;cursor:pointer;"></i></a></td>
        ...
        <script>
            ...
            var id = id;
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=18&accion=cambiarFicha",
                    data: {
                        id:id
                    },
