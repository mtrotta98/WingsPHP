            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Alta de Alumnos</h1>
                            </div>  
                        </div>
                    </div>
                </div>
                <section class="content">
                    <form action= "#" method= "post" name= "formulario_carga_alumno" id="formulario_carga_alumno" onsubmit="enviar_ajax(); return false">
                        <div class="col-md-12">
                                ...
                                <div class="card-body" style="display: block;">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" id="dom" class="form-control" placeholder="Domicilio" name="dom">
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" data-inputmask-alias="date" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" id="datemask1" name="ingreso">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                                <label>Observaciones</label>
                                                <textarea id="observaciones" class="form-control" placeholder="Observaciones" name="observaciones" maxlength="255"></textarea>
                                        </div>
                                        <div class="col-12">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <input type="submit" class="btn btn-block btn-default" value="Cancelar" onclick="location.href='alumnos.php'">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                                           
...
<script>
        function enviar_ajax() {
                $.ajax({
                    type: "POST",
                    url: "acciones.php?valor=0&accion=cargar",
                    data: $("#formulario_carga_alumno").serialize(),
